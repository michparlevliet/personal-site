...
<table>
  ...
  <?php while( $record = mysqli_fetch_assoc( $result ) ): ?>
    <tr>
      ...
      <td align="center"><a class="small_btn" href="users_edit.php?id=<?php echo $record['id']; ?>">Edit</a></td>
      <td align="center">
        <?php if( $_SESSION['id'] != $record['id'] ): ?>
          <a class="del_btn" href="users.php?delete=<?php echo $record['id']; ?>" onclick="javascript:confirm('Are you sure you want to delete this user?');">Delete</a>
        <?php endif; ?>
      </td>
      <td align="center">
...
<p><a class="small_btn" href="users_add.php"><i class="fas fa-plus-square"></i> Add User</a></p>
